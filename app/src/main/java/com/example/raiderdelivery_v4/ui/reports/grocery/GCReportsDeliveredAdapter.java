...
public class GCReportsDeliveredAdapter extends ArrayAdapter<GCDownloadedReportData> implements Filterable {
    private static final String TAG = "GCReportsDeliveredAdapter";
    ...
    public GCReportsDeliveredAdapter(@NonNull Context context, int resource, @NonNull ArrayList<GCDownloadedReportData> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final View result;
        GCReportsDeliveredAdapter.ViewHolder holder;

        LayoutInflater inflater = LayoutInflater.from(mContext);
        convertView = inflater.inflate(mResource, null, false);

        holder = new GCReportsDeliveredAdapter.ViewHolder();
