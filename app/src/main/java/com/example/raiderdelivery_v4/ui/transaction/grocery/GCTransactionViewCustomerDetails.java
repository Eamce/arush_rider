...
public class GCTransactionViewCustomerDetails extends AppCompatActivity {
    Ajax mo;
    ProgressDialog pd1;
    ...
    ArrayList<GCDownloadedCustomerData> itemlist;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gc_transaction_view_customer_detail);
        civ_customer_profilepic = findViewById(R.id.civ_gc_customer_profilepic);
        tv_customer_acc_fullname = findViewById(R.id.tv_gc_customer_acc_fullname);
        et_customer_address1 = findViewById(R.id.et_gc_customer_address1);
        et_customer_address2 = findViewById(R.id.et_gc_customer_address2);
        et_customer_address3 = findViewById(R.id.et_gc_customer_address3);
        et_customer_address1_landmark = findViewById(R.id.et_gc_customer_address1_landmark);
        et_customer_address2_landmark = findViewById(R.id.et_gc_customer_address2_landmark);
        et_customer_address3_landmark = findViewById(R.id.et_gc_customer_address3_landmark);
        et_customer_mobile1 = findViewById(R.id.et_gc_customer_mobile1);
        et_customer_mobile2 = findViewById(R.id.et_gc_customer_mobile2);
        et_customer_mobile3 = findViewById(R.id.et_gc_customer_mobile3);
        btn_address1 = findViewById(R.id.btn_gc_address1);
        btn_address2 = findViewById(R.id.btn_gc_address2);
        btn_address3 = findViewById(R.id.btn_gc_address3);
        btn_address1_landmark = findViewById(R.id.btn_gc_address1_landmark);
        btn_address2_landmark = findViewById(R.id.btn_gc_address2_landmark);
        btn_address3_landmark = findViewById(R.id.btn_gc_address3_landmark);
        btn_mobile1 = findViewById(R.id.btn_gc_mobile1);
        btn_mobile2 = findViewById(R.id.btn_gc_mobile2);
        btn_mobile3 = findViewById(R.id.btn_gc_mobile3);
        btn_customer_details_cancel = findViewById(R.id.btn_gc_customer_details_cancel);
        ...
        btn_customer_details_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (activity.equals("GCTransactionActivity")) {
                    Intent i = new Intent(GCTransactionViewCustomerDetails.this, GCTransactionActivity.class);
                    startActivity(i);
                }
                else
                {
                    Intent i = new Intent(GCTransactionViewCustomerDetails.this, GCHistoryActivity.class);
                    startActivity(i);
                }
            }
        });
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                if(!isFinishing()) {
                    ...
                    View dialogView = LayoutInflater.from(GCTransactionViewCustomerDetails.this).inflate(R.layout.my_dialog_session_timedout, viewGroup, false);
                    ...
                    androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(GCTransactionViewCustomerDetails.this);
                    ...
                    btn_ok.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            alertDialog.cancel();
                            Intent intent = new Intent(GCTransactionViewCustomerDetails.this, Login.class);
    ...
    public void getCustomerDetails() {
        ...
        String a1 = str_ticket_id;
        String a2 = str_ticket_id;
        mo.adddata("ticket_id", str_ticket_id);
        mo.execute(Globalvars.online_link + "gc_get_customer_details");
    }
