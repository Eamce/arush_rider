...
public class HistoryAdapter extends ArrayAdapter<DownloadedHistoryData> implements Filterable {
    private static final String TAG = "HistoryAdapter";
    public String langName;
    private Context mContext;
    private int mResource;
    private int lastPosition = -1;
    public ArrayList<DownloadedHistoryData> languageModelList;
    ...
    public HistoryAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DownloadedHistoryData> objects) {
    ...
    @Override
    public DownloadedHistoryData getItem(int position) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.holdname =  convertView.findViewById(R.id.tv_history_name);
        holder.holdaddress = convertView.findViewById(R.id.tv_history_address);
        holder.holdcontactno = convertView.findViewById(R.id.tv_history_contactno);
        holder.holdorderfrom = convertView.findViewById(R.id.tv_history_thru);
        holder.holdticketno = convertView.findViewById(R.id.tv_history_ticket_no);
        holder.holdorder =  convertView.findViewById(R.id.tv_history_order);
        holder.holdnumpack = convertView.findViewById(R.id.tv_history_num_pack);
        holder.holdertotalamount =  convertView.findViewById(R.id.tv_history_amount);
        holder.holdsubtotal =  convertView.findViewById(R.id.btn_history_subtotal);
        holder.holdview = convertView.findViewById(R.id.btn_history_view);
        holder.holdthru = convertView.findViewById(R.id.btn_history_type);
        holder.holdcreatedat = convertView.findViewById(R.id.tv_history_created_at);
        holder.holdtenderedamount = convertView.findViewById(R.id.tv_history_tendered_amount);
        holder.holdchange = convertView.findViewById(R.id.tv_history_change);
        holder.holdcountrider = convertView.findViewById(R.id.tv_history_count_rider);
        holder.holdmainriderstat = convertView.findViewById(R.id.btn_history_mainriderstat);
        holder.holddeliverystatus = convertView.findViewById(R.id.btn_del_status);
        holder.holdpaymentplatform = convertView.findViewById(R.id.tv_history_payment_method);
        ...
        Double dbl_subtotal = dbl_total_amt + dbl_total_charges;
    ...
    public void  setData(ArrayList<DownloadedHistoryData> modelList) {
