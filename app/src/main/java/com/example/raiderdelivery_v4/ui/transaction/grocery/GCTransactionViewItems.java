...
import com.example.raiderdelivery_v4.ui.transaction.food.TransactionViewItemsAdapter;
...
public class GCTransactionViewItems extends AppCompatActivity {
    Ajax mo, mo1;
    ArrayList<GCDownloadedStoreData> itemlist;
    LinkedHashMap<String, GCDownloadedStoreData> expandableListDetail = new LinkedHashMap<String, GCDownloadedStoreData>();
    ExpandableListView lv_transaction_view_items;
    GCTransactionViewItemsAdapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gc_transaction_view_items);
        lv_transaction_view_items = findViewById(R.id.elv_gc_trans_view_items2);


        tv_grandtotal = findViewById(R.id.tv_gc_transaction_view_items_grandtotal2);
        tv_transaction_view_items_note = findViewById(R.id.tv_gc_transaction_view_items_note2);
        tv_transaction_view_items_no_of_items = findViewById(R.id.tv_gc_transaction_view_items_no_of_items2);
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                if(!isFinishing()) {
                    ...
                    View dialogView = LayoutInflater.from(GCTransactionViewItems.this).inflate(R.layout.my_dialog_session_timedout, viewGroup, false);
                    ...
                    androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(GCTransactionViewItems.this);
                    ...
                    btn_ok.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            alertDialog.cancel();
                            Intent intent = new Intent(GCTransactionViewItems.this, Login.class);
    ...
    public void get_items_breakdown() {
        itemlist = new ArrayList<GCDownloadedStoreData>();
        ...
        mo.setCustomObjectListener(new Ajax.MyCustomObjectListener() {
            ...
            public void onsuccess(String data) {
                JSONArray thedata;
                ArrayList<HashMap<String, ArrayList<GCDownloadedItemsData>>> detailss = new ArrayList<HashMap<String, ArrayList<GCDownloadedItemsData>>>();
                try {
                    thedata = new JSONArray(data);
                    String id, prod_image, prod_name, prod_desc, prod_price, prod_qty, prod_subtotal, prod_delivery_charge;
                    String prod_picking_charge, prod_tenant, prod_bu, prod_total_by_tenant, prod_discounted_amount;
                    if (thedata.length() > 0) {
                        for (int a = 0; a < thedata.length(); a++) {
                            ...
                            prod_desc = "";
                            prod_price = row.getString(3);
                            prod_qty = row.getString(4);
                            prod_subtotal = row.getString(5);
                            prod_delivery_charge = row.getString(6);
                            prod_picking_charge = row.getString(7);
                            prod_bu = row.getString(8);
                            prod_tenant = prod_bu;
                            prod_total_by_tenant = row.getString(9);
                            prod_discounted_amount = row.getString(10);
...
//                            }
                        ...
                        adapter = new GCTransactionViewItemsAdapter(GCTransactionViewItems.this, itemlist);
                    ...
                    tv_transaction_view_items_note.setText("Additional delivery charge + Picking Charge (\u20B1" + intent.getExtras().getString("delivery_charge") + " + \u20B1" + intent.getExtras().getString("picking_charge") + ")");
        ...
        mo.execute(Globalvars.online_link + "gc_get_items_breakdown");
    }
    ...
    public int addProduct(String id, String tenant, String prod_image, String prod_name, String prod_desc, String prod_price, String prod_qty, String prod_subtotal, String prod_total_by_tenant, String prod_discounted_amount) {
        ...
        GCDownloadedStoreData headerInfo = expandableListDetail.get(tenant);
        //add the group if doesn't exists
        if (headerInfo == null) {
            //String total = get_items_breakdown_total_by_tenant(tenant);
            headerInfo = new GCDownloadedStoreData();
        ...
        ArrayList<GCDownloadedItemsData> productList = headerInfo.getProductList();
        ...
        GCDownloadedItemsData detailInfo = new GCDownloadedItemsData();
