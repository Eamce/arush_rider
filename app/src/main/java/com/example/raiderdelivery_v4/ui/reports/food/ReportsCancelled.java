...
public class ReportsCancelled extends AppCompatActivity {
    Globalvars globalvars;
    ArrayList<DownloadedReportData> itemlist;
    Ajax mo;
    ReportsCancelledAdapter adapter;
    ...
    Boolean web_is_empty = false, mobile_is_empty = false, is_empty2 = false, mobile_is_empty2 = false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reports_cancelled);
        tv_grandtotal = findViewById(R.id.tv_reports_cancelled_total);
        tv_delivered_note = findViewById(R.id.tv_cancelledreports_note);
        tv_deliveredreports_no_of_customer = findViewById(R.id.tv_cancelledreports_no_of_customer);
        ll_delivered_noresults = findViewById(R.id.ll_cancelled_noresults);
        iv_delivered_noresult = findViewById(R.id.iv_cancelled_noresult);
        tv_delivered_noresults = findViewById(R.id.tv_cancelled_noresults);
        lv_deliveredreports = findViewById(R.id.lv_cancelledreports);
    ...
    public void get_cancelled_reports_all(){
        ...
        mo.setCustomObjectListener(new Ajax.MyCustomObjectListener() {
            ...
            public void onsuccess(String data) {
                ...
                try {
                    ...
                    String id, ticket_no, fname, lname, fullname, barangay, town, address, order, charge, totalamount, discount, view_stat, ontransit, delivered, cancelled, remitted, contact_no, order_from, tendered_amount, change, main_rider_stat, count_rider, return_change_to_tenant;
                    if (thedata.length() > 0)
                    {
                        ...
                        adapter = new ReportsCancelledAdapter(ReportsCancelled.this,R.layout.reports_content, itemlist);
                    ...
                    if(!is_empty2){
                        ...
                        tv_delivered_note.setText("Discounted Amt. + Del. Charge(P " + df.format(dbl_grandtotal) + " + P " + df.format(dbl_delivery_charge) + ")");
    ...
    public void get_cancelled_reports_ol_payment(){
        itemlist = new ArrayList<>();
        pd = new ProgressDialog(this);
        pd.setMessage("Please wait...");
        pd.show();
    ...
    public void get_cancelled_reports_cod(){
        itemlist = new ArrayList<>();
        pd = new ProgressDialog(this);
        pd.setMessage("Please wait...");
        pd.show();
