...
public class TransactionViewTimeFrame extends AppCompatActivity {
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (activity.equals("TransactionActivity")) {
                    Intent i = new Intent(TransactionViewTimeFrame.this, TransactionActivity.class);
                    startActivity(i);
                } else {
                    Intent i = new Intent(TransactionViewTimeFrame.this, HistoryActivity.class);
                    startActivity(i);
                }
            }
        });
    ...
    public void CreateLayout(){
                ...
                try {
                    ...
                    if (thedata.length() > 0) {
                        for (int a = 0; a < thedata.length(); a++) {
                            ...
                            LinearLayout ll1 = new LinearLayout(TransactionViewTimeFrame.this);
                            ...
                            TextView tv0 = new TextView(TransactionViewTimeFrame.this);

                            TextView tv1 = new TextView(TransactionViewTimeFrame.this);
                            EditText et1 = new EditText(TransactionViewTimeFrame.this);

                            TextView tv2 = new TextView(TransactionViewTimeFrame.this);
                            TextView tv22 = new TextView(TransactionViewTimeFrame.this);
                            EditText et2 = new EditText(TransactionViewTimeFrame.this);

                            TextView tv3 = new TextView(TransactionViewTimeFrame.this);
                            TextView tv33 = new TextView(TransactionViewTimeFrame.this);
                            EditText et3 = new EditText(TransactionViewTimeFrame.this);

                            TextView tv4 = new TextView(TransactionViewTimeFrame.this);
                            TextView tv44 = new TextView(TransactionViewTimeFrame.this);
                            EditText et4 = new EditText(TransactionViewTimeFrame.this);

                            TextView tv5 = new TextView(TransactionViewTimeFrame.this);
                            TextView tv55 = new TextView(TransactionViewTimeFrame.this);
                            EditText et5 = new EditText(TransactionViewTimeFrame.this);
        ...
        mo.execute(Globalvars.online_link + "get_tenant_timeframe");
