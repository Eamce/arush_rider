...
import com.example.raiderdelivery_v4.ui.reports.food.ReportsCancelled;
import com.example.raiderdelivery_v4.ui.reports.food.ReportsCancelledAdapter;
...
public class GCReportsCancelled extends AppCompatActivity {
    Globalvars globalvars;
    ArrayList<GCDownloadedReportData> itemlist;
    Ajax mo;
    GCReportsCancelledAdapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gc_reports_cancelled);
        tv_grandtotal = findViewById(R.id.tv_gc_reports_cancelled_total);
        tv_delivered_note = findViewById(R.id.tv_gc_cancelledreports_note);
        tv_deliveredreports_no_of_customer = findViewById(R.id.tv_gc_cancelledreports_no_of_customer);
        ll_delivered_noresults = findViewById(R.id.ll_gc_cancelled_noresults);
        iv_delivered_noresult = findViewById(R.id.iv_gc_cancelled_noresult);
        tv_delivered_noresults = findViewById(R.id.tv_gc_cancelled_noresults);
        lv_deliveredreports = findViewById(R.id.lv_gc_cancelledreports);
        globalvars = new Globalvars(this,this);
        this.setTitle("Cancelled Report(Grocery)");
        get_cancelled_reports();
    }

    public void get_cancelled_reports(){
            ...
            public void onsuccess(String data) {
                ...
                try {
                    ...
                    if (thedata.length() > 0)
                    {
                        ...
                        adapter = new GCReportsCancelledAdapter(GCReportsCancelled.this,R.layout.gc_reports_content, itemlist);
