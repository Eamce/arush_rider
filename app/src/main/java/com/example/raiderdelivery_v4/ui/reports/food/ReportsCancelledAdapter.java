...
public class ReportsCancelledAdapter extends ArrayAdapter<DownloadedReportData> implements Filterable {
    ...
    public ReportsCancelledAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DownloadedReportData> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final View result;
        ReportsDeliveredAdapter.ViewHolder holder;

        LayoutInflater inflater = LayoutInflater.from(mContext);
        convertView = inflater.inflate(mResource, null, false);

        holder = new ReportsDeliveredAdapter.ViewHolder();
        ...
        holder.holdcontactno = convertView.findViewById(R.id.tv_reports_contactno);
        ...
        holder.holdmainriderstat = convertView.findViewById(R.id.btn_reports_mainriderstat);
