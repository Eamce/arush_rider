...
public class GCDownloadedTransactionData {
    private String id;
    ...
    private String picking_charge;
    private String payment_platform;

    public GCDownloadedTransactionData(String id, String cus_id, String name, String address, String order, String charge, String totalamount, String discount, String view_stat, String ontransit, String delivered, String cancelled,String ticket_no, String contact_no, String no_pack, String order_from, String create_at, String tendered_amount, String change, String change_bu, String main_rider_stat, String count_rider, String instructions, String submit_status, String picking_charge, String payment_platform) {
        this.id = id;
        this.cus_id = cus_id;
        this.name = name;
        ...
        this.picking_charge = picking_charge;
    ...
    public String getPicking_charge() {
        return picking_charge;
    }

    public void setPicking_charge(String picking_charge) {
        this.picking_charge = picking_charge;
    }
}
