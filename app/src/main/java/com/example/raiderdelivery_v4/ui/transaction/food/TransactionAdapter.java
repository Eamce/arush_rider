...
public class TransactionAdapter extends ArrayAdapter<DownloadedTransactionData> implements Filterable {
    private static final String TAG = "TransactionAdapter";
    public String langName, str_ago;
    private Context mContext;
    private int mResource;
    private int lastPosition = -1;
    public ArrayList<DownloadedTransactionData> languageModelList;
    ...
    public TransactionAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DownloadedTransactionData> objects) {
    ...
    @Override
    public DownloadedTransactionData getItem(int position) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.holdname =  convertView.findViewById(R.id.tv_name);
        holder.holdaddress =  convertView.findViewById(R.id.tv_address);
        holder.holdcontactno = convertView.findViewById(R.id.tv_contact_no);
        holder.holdthru = convertView.findViewById(R.id.tv_thru);
        holder.holdticketno = convertView.findViewById(R.id.tv_ticket_no);
        holder.holdorder =  convertView.findViewById(R.id.tv_order);
        holder.holdnopack =  convertView.findViewById(R.id.tv_num_pack);
        holder.holdcountrider = convertView.findViewById(R.id.tv_count_rider);
        holder.holdtenderedamount = convertView.findViewById(R.id.tv_tendered_amount);
        holder.holdchange = convertView.findViewById(R.id.tv_change);
        holder.holdertotalamount =  convertView.findViewById(R.id.tv_amount);
        holder.holddontransit =  convertView.findViewById(R.id.btn_ontransit);
        holder.holddelivered =  convertView.findViewById(R.id.btn_delivered);
        holder.holdsubtotal =  convertView.findViewById(R.id.btn_subtotal);
        holder.holdview =  convertView.findViewById(R.id.btn_view);
        holder.holdorderfrom = convertView.findViewById(R.id.btn_transaction_type);
        holder.holdercreated_at = convertView.findViewById(R.id.tv_created_at);
        holder.holdmainriderstat = convertView.findViewById(R.id.btn_main_rider_stat);
        holder.holdinstructions = convertView.findViewById(R.id.tv_instructions);
        holder.holdinstructions = convertView.findViewById(R.id.tv_payment_method);
        holder.holdpaymentplatform = convertView.findViewById(R.id.tv_payment_method);
        ...
        Double dbl_subtotal;
        dbl_subtotal = dbl_total_amt + dbl_total_charges;
...
//        if(str_payment_platform.equalsIgnoreCase("Cash on Delivery"))
//        {
//            str_payment_platform = "Cash on Delivery";
//        }
//        else
//        {
//            str_payment_platform = "Online Payment";
//        }
    ...
    public void  setData(ArrayList<DownloadedTransactionData> modelList) {
