...
public class GCReportsUndeliveredAdapter extends ArrayAdapter<GCDownloadedReportData> implements Filterable {
    ...
    public GCReportsUndeliveredAdapter(@NonNull Context context, int resource, @NonNull ArrayList<GCDownloadedReportData> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final View result;
        GCReportsUndeliveredAdapter.ViewHolder holder;

        LayoutInflater inflater = LayoutInflater.from(mContext);
        convertView = inflater.inflate(mResource, null, false);

        holder = new GCReportsUndeliveredAdapter.ViewHolder();
        ...
        holder.holdcontact = convertView.findViewById(R.id.tv_gc_reports_contactno);
