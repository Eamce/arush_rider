...
public class ReportsDeliveredAdapter extends ArrayAdapter<DownloadedReportData> implements Filterable {
    ...
    public ReportsDeliveredAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DownloadedReportData> objects) {
